...
<!--Fín Código Css fuente-->

</head>
<body style="background:#FBFBFB; padding:0px;">

<header  class="hd">
        <div>
            <img src="img/headerpropuesta.svg" width="100%"></img>      
        </div>
...
.titulosass {
    ...
    border: solid 1px #6A00A7;
  /* box-shadow: 5px 10px rgba(202, 154, 229, 0.49);*/
   box-shadow: none;
    text-align: center;
    color: #6A00A7;
    padding:auto;
...
<section class="sectionht" style="padding: 0px, 0px, 0px, 0px;">
      <h2 class="titulosass" >CAPÍTULO I - FEE MENSUAL SERVICIO DE SOFTWARE (ABONO SAAS)</h2>
       <br>
 <p style=
  "text-align: justify;
    font-size: 16px;
      ...
      <tr>
        ...
        <!--nuevos items dentro de Circuito Específico-->
            ...
            <td class="bordervirtuales2 anchodecolumna2">Accesos Virtuales</td>
               ...
               <td class="altofilaoff">Off<input type="text" id="celda171" class="imputw" readonly oninput="calcularTotal('celda171', 'celda181', 'resultado9')">meses</td>
...
<section class="sectionlast">
    ...
    <div>
       <p class="onelab" for="emision">Fecha de Emisión:</p>
       <p class="one" id="fechaActual"></p>
   
    </div>
    <div>
         <label class="one2lab" for="vencimiento">Fecha de Vencimiento:</label><br>
